        ...
        <>
          ...
          <div className="center" style={{ maxWidth: 1128 }}>
            <SWrapper>
              ...
              <SParagraphLead>
                MyBit designs products that open up the world, creating tools
                that enable freedom and wealth generation for everyone. We
                believe that closed, centrally controlled systems limit our
                potential as a society, and that truly transparent and open
                collaboration will power the future.
              </SParagraphLead>
              ...
              <div className="flex flex-row items-top justify-between items-end">
                ...
                >
                  ...
                  <SParagraph>
                    Our initial seed level funding round allowed us to expand
                    the scope of our vision and build functional tools to power
                    the new economy. Following a successful initial token
                    distribution in 2017 we put our heads down and began
                    developing technology that enables a more open,
                    collaborative, and accessible way of working. You can
              ...
              <div className="dn-ns">
                ...
                <SParagraph>
                  ...
                  scope of our vision and build functional tools to power the
                  new economy. Following a successful initial token distribution
                  in 2017 we put our heads down and began developing technology
                  that enables a more open, collaborative and accessible way of
              ...
              <SParagraphLead>
                MyBit allows anyone to finance and build the blockchain-powered
                products that will revolutionise and disrupt transaction-based
                industries.
              </SParagraphLead>
              ...
              <div className="pv6" style={{ backgroundColor: '#0B3F9C' }}>
                <SParagraphLeadTl color="white">
                  The MyBit Community will be fully in charge of the project by
                  the end of 2019 as we transition to a fully decentralised
                  governance structure. That means we will be creating one of
                  the first self-governing, co-operative tech projects on the
                  web and a blueprint for future DAOs. Our community will not
                  only deploy the MyBit token to develop and scale projects, but
                  also stake the tokens to vote on major company decisions and
                  operations.
                  <div className="pt3">
                    <Btn
                      text="MyBit DAO (v0.3)"
