        ...
        <>
          ...
          <div className="center" style={{ maxWidth: 1128 }}>
            <SWrapper>
              ...
              <SParagraphLead>
                MyBit was started by a group of industry veterans frustrated by
                the limitations of today’s financial systems. In a global
                economy where trust is invaluable and hard to come by, third
                party providers like lawyers, managers, and deal brokers have
                created inefficiencies while taking large percentages as
                profits.
              </SParagraphLead>
              <div className="pt6" />
              ...
              <SParagraphLead>
                The MyBit Ecosystem consists of four components; Our Community,
                Our Technology, Our Governance model, and the MyBit Token.
              </SParagraphLead>
