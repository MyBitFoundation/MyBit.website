export const mediaVerticals = [{
  ...
  content:
    '<p>The MyBit Network functions as a multi-industrial investment platform. </br>This means it is applicable to all markets, across all industries, in all countries.</p>',
  iconClassName: '',
  isCentered: true
}]
